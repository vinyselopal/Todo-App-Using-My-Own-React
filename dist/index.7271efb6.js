...
function render(elm, parent) {
    const state = componentStates.get(parent) || {
        cache: []
    };
    componentStates.set(parent, {
        ...state,
        component: elm
    });
    ...
    const element = component.type === "TEXT_ELEMENT" ? document.createTextNode(component.nodeValue) : document.createElement(component.type);
